...
<template>
  ...
  <div v-else-if="m.role === 'tool'" class="msg msg--tool">
    <div class="card" style="margin:0">
      <div class="card-head" style="padding:6px 10px;display:flex;align-items:center;gap:8px;font-size:12px">
      ...
      <div v-if="m.output || m.err" class="card-body" style="padding:4px 10px;font-size:11px;max-height:200px;overflow-y:auto;white-space:pre-wrap;background:var(--bg-2);color:var(--fg-2);border-top:1px solid var(--border)">{{ m.err || m.output }}</div>
    </div>
  </div>
</template>
