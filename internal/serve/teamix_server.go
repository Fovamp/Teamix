...
func (ts *TeamixServer) buildHandler() http.Handler {
	...
	mux.HandleFunc("POST /teamix/archive/restore", ts.withUser(ts.handleArchiveRestore))
	mux.HandleFunc("POST /teamix/archive/delete", ts.withUser(ts.handleArchiveDelete))
	...
	mux.HandleFunc("GET /teamix/nacos", ts.withUser(ts.handleNacosGet))
	mux.HandleFunc("POST /teamix/nacos", ts.withUser(ts.handleNacosSave))
	mux.HandleFunc("GET /teamix/nacos/user", ts.withUser(ts.handleNacosUserGet))
	mux.HandleFunc("POST /teamix/nacos/user", ts.withUser(ts.handleNacosUserSave))
